...
bb3.i:                                            ; preds = %bb1.i
  ...
  br i1 %exitcond30, label %bb.nph8.i, label %bb.nph.i

bb.nph.i8:                                        ; preds = %bb.nph8.i, %bb4.i10
  %indvar21.i = phi i64 [ %tmp26, %bb4.i10 ], [ 0, %bb.nph8.i ] ; <i64> [#uses=5]
  ...
  %.pre47.i = load double* %scevgep25.phi.trans.insert.i, align 8 ; <double> [#uses=1]
  %.pre48.i = load double* %scevgep.phi.trans.insert.i, align 8 ; <double> [#uses=1]
  %.pre49.i = load double* %scevgep30.phi.trans.insert.i, align 32 ; <double> [#uses=1]
  br label %bb2.i

bb2.i:                                            ; preds = %bb2.i, %bb.nph.i8
  %5 = phi double [ %.pre49.i, %bb.nph.i8 ], [ %22, %bb2.i ] ; <double> [#uses=1]
  %6 = phi double [ %.pre48.i, %bb.nph.i8 ], [ %20, %bb2.i ] ; <double> [#uses=1]
  %7 = phi double [ %.pre47.i, %bb.nph.i8 ], [ %15, %bb2.i ] ; <double> [#uses=1]
...
bb6.i:                                            ; preds = %bb4.i10
  ...
  br i1 %exitcond28, label %scop_func.exit, label %bb.nph8.i
