...
bb3.us.i:                                         ; preds = %bb1.us.i
  ...
  %exitcond18 = icmp eq i64 %indvar.next9.i, 8000 ; <i1> [#uses=1]
...
bb.i5:                                            ; preds = %bb.i5, %bb3.us.i
  ...
  %scevgep20.i = getelementptr [8000 x double]* @s, i64 0, i64 %storemerge9.i ; <double*> [#uses=1]
  store double 0.000000e+00, double* %scevgep20.i, align 8
  %5 = add nsw i64 %storemerge9.i, 1              ; <i64> [#uses=2]
  %exitcond16 = icmp eq i64 %5, 8000              ; <i1> [#uses=1]
  br i1 %exitcond16, label %bb.nph.us.i9, label %bb.i5

bb6.us.i:                                         ; preds = %bb4.us.i
  store double %13, double* %scevgep15.i
  %6 = add nsw i64 %storemerge14.us.i, 1          ; <i64> [#uses=2]
  %exitcond15 = icmp eq i64 %6, 8000              ; <i1> [#uses=1]
  br i1 %exitcond15, label %scop_func.exit, label %bb.nph.us.i9
...
bb4.us.i:                                         ; preds = %bb.nph.us.i9, %bb4.us.i
  ...
  %exitcond14 = icmp eq i64 %14, 8000             ; <i1> [#uses=1]
