...
bb12.i:                                           ; preds = %bb10.i
  ...
  br i1 %exitcond38, label %bb11.preheader.i, label %bb.nph.i
...
bb3.us.i:                                         ; preds = %bb.nph.us.i, %bb3.us.i
  ...
  %scevgep51.i = getelementptr [128 x [128 x [128 x double]]]* @A, i64 0, i64 %storemerge30.i, i64 %storemerge113.i, i64 %storemerge45.us.i ; <double*> [#uses=1]
...
bb.nph.us.i:                                      ; preds = %bb6.preheader.i, %bb5.us.i
  ...
  %scevgep54.i = getelementptr [128 x [128 x [128 x double]]]* @sum, i64 0, i64 %storemerge30.i, i64 %storemerge113.i, i64 %storemerge26.us.i ; <double*> [#uses=2]
...
bb8.i12:                                          ; preds = %bb8.i12, %bb5.us.i
  ...
  %scevgep57.i = getelementptr [128 x [128 x [128 x double]]]* @sum, i64 0, i64 %storemerge30.i, i64 %storemerge113.i, i64 %storemerge311.i ; <double*> [#uses=1]
  %scevgep56.i = getelementptr [128 x [128 x [128 x double]]]* @A, i64 0, i64 %storemerge30.i, i64 %storemerge113.i, i64 %storemerge311.i ; <double*> [#uses=1]
  %16 = load double* %scevgep57.i, align 8        ; <double> [#uses=1]
  store double %16, double* %scevgep56.i, align 8
...
bb6.preheader.i:                                  ; preds = %bb11.preheader.i, %bb10.i13
  %storemerge113.i = phi i64 [ %18, %bb10.i13 ], [ 0, %bb11.preheader.i ] ; <i64> [#uses=5]
  br label %bb.nph.us.i

bb12.i14:                                         ; preds = %bb10.i13
  %19 = add nsw i64 %storemerge30.i, 1            ; <i64> [#uses=2]
  %exitcond35 = icmp eq i64 %19, 128              ; <i1> [#uses=1]
  br i1 %exitcond35, label %scop_func.exit, label %bb11.preheader.i

bb11.preheader.i:                                 ; preds = %bb12.i14, %bb12.i
  %storemerge30.i = phi i64 [ %19, %bb12.i14 ], [ 0, %bb12.i ] ; <i64> [#uses=5]
