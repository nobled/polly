; RUN: %opt -mem2reg -loopsimplify -indvars -polly-prepare -polly-detect -debug-only=polly-detect -polly-print %s | FileCheck %s
...
; CHECK: In function: 'scop_func' SCoP: bb5.preheader => return:
