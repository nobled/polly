...
bb1.i12:                                          ; preds = %bb2.preheader.i, %bb1.i12
  ...
  %6 = load double* %scevgep68.i, align 8         ; <double> [#uses=1]
...
bb5.i13:                                          ; preds = %bb6.preheader.i14, %bb5.i13
  %indvar33.i = phi i64 [ %indvar.next34.i, %bb5.i13 ], [ 0, %bb6.preheader.i14 ] ; <i64> [#uses=2]
  %tmp49 = add i64 %tmp44, %indvar33.i            ; <i64> [#uses=2]
  %scevgep44.i = getelementptr [1024 x [1024 x double]]* @A, i64 0, i64 %tmp48, i64 %tmp49 ; <double*> [#uses=2]
  %scevgep45.i = getelementptr [1024 x [1024 x double]]* @A, i64 0, i64 0, i64 %tmp49 ; <double*> [#uses=1]
  %8 = load double* %scevgep44.i, align 8         ; <double> [#uses=1]
  %9 = load double* %scevgep54.i, align 8         ; <double> [#uses=1]
  %10 = load double* %scevgep45.i, align 8        ; <double> [#uses=1]
  %11 = fmul double %9, %10                       ; <double> [#uses=1]
  %12 = fsub double %8, %11                       ; <double> [#uses=1]
  store double %12, double* %scevgep44.i, align 8
  %indvar.next34.i = add i64 %indvar33.i, 1       ; <i64> [#uses=2]
  %exitcond24 = icmp eq i64 %indvar.next34.i, %tmp23 ; <i1> [#uses=1]
...
bb6.preheader.i14:                                ; preds = %bb8.loopexit4.i, %bb8.loopexit.i
  %indvar38.i = phi i64 [ %tmp48, %bb8.loopexit4.i ], [ 0, %bb8.loopexit.i ] ; <i64> [#uses=1]
  %tmp48 = add i64 %indvar38.i, 1                 ; <i64> [#uses=4]
  %scevgep54.i = getelementptr [1024 x [1024 x double]]* @A, i64 0, i64 %tmp48, i64 %tmp43 ; <double*> [#uses=1]
  br label %bb5.i13
...
bb2.preheader.i:                                  ; preds = %bb9.i15, %bb3.i
  ...
  %scevgep68.i = getelementptr [1024 x [1024 x double]]* @A, i64 0, i64 0, i64 %tmp43 ; <double*> [#uses=1]
